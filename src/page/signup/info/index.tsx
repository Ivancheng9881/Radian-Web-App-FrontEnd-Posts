...
const SignupInfoPage: FC = () => {
  ...
  const TAG_OPTIONS = [{ label: "radian passport", value: "radian passport" }];
    ...
    <div className="rd-signup-body">
      <div className="rd-signup-illustration">
        <img
          ...
          src={`${config.assets.cdn}/signup/illustration_1_desktop.png`}
          alt="background-img"
        />
      </div>
      <SignupFormWrapper>
        <div className="rd-signup-form-root">
          ...
          <div className="rd-signup-form-body">
            ...
            <Row className="rd-signup-row" gutter={[HORIZONTAL_GUTTER, 30]}>
              <Col lg={8} md={12}>
                <RadianForm.Label
                  label="First Name"
                  required
                ...
                >
                  <RadianForm.Input
                    id="signup-firstName"
                    onChange={(e) =>
                      handleValUpdate("firstName", e.target.value)
                    }
              ...
              <Col lg={8} md={12}>
                ...
                >
                  <RadianForm.Input
                    id="signup-lastName"
                    onChange={(e) =>
                      handleValUpdate("lastName", e.target.value)
                    }
                    value={info.lastName}
                  />
                </RadianForm.Label>
              ...
              <Col lg={8} md={12}>
                ...
                >
                  <RadianForm.Input
                    ...
                    id="signup-username"
                    onChange={(e) =>
                      handleValUpdate("username", e.target.value)
                    }
                    value={info.username}
                  />
                </RadianForm.Label>
              ...
              <Col lg={8} md={12}>
                ...
                >
                  <RadianForm.Input
                    id="signup-location"
                    onChange={(e) =>
                      handleValUpdate("location", e.target.value)
                    }
                    value={info.location}
                  />
                </RadianForm.Label>
              ...
              <Col lg={8} md={12}>
                <RadianForm.Label label="Religion">
                  <RadianForm.Input
                    id="signup-religion"
                    onChange={(e) =>
                      handleValUpdate("religion", e.target.value)
                    }
                    value={info.religion}
                  />
                </RadianForm.Label>
              ...
              <Col lg={8} md={12}>
                ...
                >
                  <RadianForm.Input
                    ...
                    onChange={(e) =>
                      handleValUpdate("nationality", e.target.value)
                    }
              ...
              <Col lg={8} md={12}>
                ...
                >
                  <RadianForm.Input
                    id="signup-ethnicity"
                    onChange={(e) =>
                      handleValUpdate("ethnicity", e.target.value)
                    }
