...
const ProfilePassport = (props) => {
    ...
    return (
        <div id="RD-CreateProfile-height" className="RD-CreateProfileComponents">
            <Typography.Featured alignment="left">Radian Passport Summary</Typography.Featured>
            <RoundedButton onClick={createProfileCid}>
                        ...
                        <div className="block">
                            {id &&
                                Object.keys(id).map((i) => {
                                    ...
                                    return <PassportItem label={i} value={val} contentType={contentType} />;
                                })}
                            {/* 
                            <PassportItem  
                                label='Date of Birth'
